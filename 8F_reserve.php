...
<?php
  ...
  if($lot==NULL) 
  {
    print "<script language=javascript> alert('주차할 자리를 선택해주세요!'); location.replace('8F.php');</script>";
    exit();
  }
  ...
  if($result) {
	  echo ("<script language=javascript>newWindow(\"$lot\"); location.replace('8F.php');</script>");
    //print "<script language=javascript> alert('등록되었습니다!'); location.replace('8F.php');</script>";
  } else {
    print "<script language=javascript> alert('등록실패했습니다. 다시 시도해주세요');location.replace('8F.php'); </script>";
  }
